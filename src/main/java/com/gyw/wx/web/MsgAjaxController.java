...
public class MsgAjaxController {
	...
	/**查询按钮 */
	/*@RequestMapping("/ajax/work/wx/sendText.hm")
	public Map<String, Object> getAll(MsgMngCondition condition){
		Map<String, Object> resultMap= new HashMap<String, Object>();
		try {
			// 第三方用户唯一凭证  
			String appId = "wxfcfd797dc3c01ab7";  
			// 第三方用户唯一凭证密钥  
			String appSecret = "2c2f23d942651309c16463dddbf6d7db";  
			// 调用接口获取access_token  
			AccessToken at = WechatUtil.getAccessToken(appId, appSecret);
			System.out.println("access_token is ::"+at.getAccess_token());
			if (null != at) {  
	            // 调用接口创建菜单  
				Object obj = WechatUtil.createMenu(getMenu(), at.getAccess_token());  
	            ...
	            if (0 == result) {
	            	...
	            	resultMap.put("errorMsg", "菜单创建失败，错误码：" + result);
	            }
	        }  
		} catch (Exception e) {
			 logger.info("菜单创建出错！",e);  
			 resultMap.put("errorMsg", "菜单创建出错！");
		}
		return  resultMap;
	}*/
